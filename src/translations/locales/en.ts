export default {
  ...
  blockchainProjects: {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Egypt’s national blockchain platform for intellectual property rights.",
      },
    ],
  },
  ...
  bilalApp: {
    ...
    projectOverviewTitle: "Project Overview",
    projectOverviewText:
      "Bilal helps you in reading Quran and moving between Juz and Surah easily with repeating features in addition to multiple answers for prayer time, local time, weather…etc., based on your location anywhere around the world. Also there are multiple features being devolved and will be revealed very soon",
  },
  sa7by: {
    title: "Sa7by",
    projectOverviewTitle: "Project Overview",
